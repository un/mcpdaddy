...
function App() {
  const upstreams: Upstream[] = [
    { id: "github", displayName: "GitHub", status: "stopped" },
    { id: "notion", displayName: "Notion", status: "stopped" },
    { id: "vercel", displayName: "Vercel", status: "stopped" },
  ];
  ...
  const profiles: ClientProfile[] = [
    {
      ...
      allowedUpstreamIds: ["github"],
    },
    {
      id: "work",
      displayName: "Work",
      exposureMode: "full",
      allowedUpstreamIds: ["github", "notion", "vercel"],
    },
  ];

  const [selection, setSelection] = useState<{ kind: "upstream" | "profile"; id: string }>(
    () => ({ kind: "upstream", id: upstreams[0]?.id ?? "github" })
  );
